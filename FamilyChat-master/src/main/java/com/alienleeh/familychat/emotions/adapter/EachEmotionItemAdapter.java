 ...
 * Description:
 */
public class EachEmotionItemAdapter extends BaseAdapter{
    ...
    public EachEmotionItemAdapter(Context context, List<String> emotionNames,int itemWidth,int emotionType) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == emotionPaths.size()){
            ImageLoaderHelper.displayAsset(view,"sticker/emotion_back.png");
        }else {
