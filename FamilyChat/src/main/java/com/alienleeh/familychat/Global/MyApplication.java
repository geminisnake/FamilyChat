...
import com.alienleeh.familychat.ui.activity.AVChatActivity;
...
public class MyApplication extends Application{
    ...
    private void enableAVChat(boolean register) {
        AVChatManager.getInstance().observeIncomingCall(new Observer<AVChatData>() {
            @Override
            public void onEvent(AVChatData chatData) {
                AVChatActivity.launch(ApplicationUtils.getContext(), chatData);
            }
        }, register);
    }
    ...
    private SDKOptions options() {
        ...
        config.notificationSmallIconId = R.drawable.ic_message_brown_200_18dp;
        // 呼吸灯配置
        ...
        options.userInfoProvider = new UserInfoProvider() {
            ...
            public int getDefaultIconResId() {
                return R.drawable.avatar_exam1;
            }
