...
import customProgress.MsgImageView;
import customProgress.ProgressImageView;
...
public class ConversationDetailAdapter extends BaseAdapter {
    ...
    private void inflateContent(final IMMessage message, final FrameLayout contentView) {
        ...
        switch (message.getMsgType()) {
            ...
            case location:
                ...
                locationImage.setUnProgress(true);
    ...
    private void setImageSize(String path, ImageAttachment attachment, MsgImageView imageView) {
        int[] bounds1 = null;
        if (path != null){
